...
固定内でだけ使う予定なのでここも周回後は消えます<br>
フィールドマーカーは弊固定通り（のはず）です
...
5.機工城アレキサンダーを潰せ！！！！！！<br>
　デフォルトで「サイコロ」「ボス位置」「懺悔」全ての要素がランダムですが、<br>
  　任意で特定のパターンだけ練習することも出来ます。<br>
...
### ・バグっぽいの見つけたらどうしたらいい？
このページの上らへんの「Issues」が報告掲示板みたいな役割なので、<br>
そこに書き込むか、Discordの固定サーバーに貼って下さい
...
### ・NURO光を契約する
[__電気通信消費者相談センター__](https://www.soumu.go.jp/main_sosiki/joho_tsusin/d_syohi/syohi/syohi_soudan.htm)
